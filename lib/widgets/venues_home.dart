...
class VenuesHome extends StatefulWidget {
  @override
  _VenuesHomeState createState() => _VenuesHomeState();
}

class _VenuesHomeState extends State<VenuesHome> {
  @override
            ...
            return GestureDetector(
              onTap: () {
                 Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => Venues(list: venuesList, index: index,)
                  )
                );
              },
              child: Card(
                ...
                child: ListTile(
                  title: Text(venuesList[index]['title']),
                  subtitle: Text(venuesList[index]['address']),
                  trailing: Text(venuesList[index]['score'], style: TextStyle(color: Colors.orangeAccent),),
                )
              ),
            );
          },
...
class Venues extends StatefulWidget {
  List list;
  int index;
  Venues({Key key,this.list, this.index}) : super(key: key);
  @override
  _VenuesState createState() => _VenuesState(list,index);
}
...
class _VenuesState extends State<Venues> {
  ...
  List<Map> list = [];
  int index ;
  _VenuesState(this.list, this.index);
 @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        new GestureDetector(
                          onTap: () {
                            Fluttertoast.showToast(msg: "预定成功");
                          },
                          child: Container(
                            decoration: BoxDecoration(
                              border: Border.all(color: Colors.blueAccent),
